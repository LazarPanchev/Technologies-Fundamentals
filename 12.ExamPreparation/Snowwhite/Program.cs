...
namespace ExamPrep2
{
    ...
    class Program
    {
        ...
        {
            var dwarfs = new List<Dwarf>(); // we create new dwarf first with default properties
            ...
            while ((input = Console.ReadLine()) != "Once upon a time")
            {
                ...
                {
                    dwarfs.Add(new Dwarf(dwarfName, dwarfHatColor, dwarfPhysics)); // we add the dwarf to our list
        ...
        public class Dwarf
        {
            ...
            public Dwarf(string name, string hatColor, int physics) // here we assign the default value properties we have above
            {
                this.Name = name;
